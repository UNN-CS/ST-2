...
TEST(CIRCLE_CLASS, zero_constructor_arg) {
    EXPECT_ANY_THROW(Circle(0.0));
}

TEST(CIRCLE_CLASS, setRadius_zero_input) {
    Circle circle(1.0);
    EXPECT_ANY_THROW(circle.setRadius(0.0));
}
TEST(CIRCLE_CLASS, setArea_zero_input) {
    Circle circle(1.0);
    EXPECT_ANY_THROW(circle.setArea(0.0));
}
TEST(CIRCLE_CLASS, setFerence_zero_input) {
    Circle circle(1.0);
    EXPECT_ANY_THROW(circle.setFerence(0.0));
}

TEST(TASKS, ropeAroundPlanetTask_Earth_1m) {
